...
function commitMove(dir){if(dir<0&&fi===0)return;if(dir>0){fi++;ensureFeed()}else fi=Math.max(0,fi-1);recordInteraction('navigation',dir>0?'next':'back');render()}
